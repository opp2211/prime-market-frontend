...
const messages = {
  ru: {
    ...
    account: {
      ...
      walletTxsTitle: 'История операций',
      walletTxsEmpty: 'Операций пока нет.',
      walletTxsError: 'Не удалось загрузить историю операций.',
      walletTxsDate: 'Дата',
      walletTxsType: 'Тип',
      walletTxsAmount: 'Сумма',
      walletTxsCurrency: 'Валюта',
      walletTxsId: 'ID операции',
      walletTxsFilterCurrency: 'Валюта',
      walletTxsFilterType: 'Тип',
      walletTxsFilterEmpty: 'Нет доступных вариантов.',
    },
    backoffice: {
      title: 'Админка',
      selectSection: 'Выберите раздел в меню слева.',
      noSections: 'Нет доступных разделов.',
      userLoadError: 'Не удалось проверить права доступа.',
      depositRequestsNav: 'Заявки на пополнение',
      depositRequestsTitle: 'Заявки на пополнение',
      depositRequestsPending: 'Ожидающие действий',
      depositRequestsAll: 'Все',
      depositRequestsEmpty: 'Заявок на пополнение пока нет.',
      depositRequestsError: 'Не удалось загрузить заявки на пополнение.',
      depositRequestTitle: 'Заявка на пополнение',
      depositRequestBack: 'К списку заявок',
      depositRequestLoadError: 'Не удалось загрузить заявку.',
      depositRequestActionError: 'Не удалось обновить заявку.',
      depositRequestInfo: 'Детали заявки',
      depositRequestActions: 'Действия',
      depositRequestUserId: 'ID пользователя',
      paymentDetailsLabel: 'Реквизиты',
      paymentDetailsPlaceholder: 'Введите реквизиты для оплаты',
      paymentDetailsRequired: 'Введите реквизиты для оплаты.',
      depositDetailsEmpty: 'Реквизиты еще не предоставлены.',
      reject: 'Отклонить',
      rejectReasonRequired: 'Укажите причину отклонения.',
      rejectReasonPlaceholder: 'Причина отклонения',
      issueDetails: 'Предоставить реквизиты',
      confirm: 'Подтвердить',
    },
    home: {
  ...
  en: {
    ...
    account: {
      ...
      walletTxsTitle: 'Transaction history',
      walletTxsEmpty: 'No transactions yet.',
      walletTxsError: "Couldn't load transaction history.",
      walletTxsDate: 'Date',
      walletTxsType: 'Type',
      walletTxsAmount: 'Amount',
      walletTxsCurrency: 'Currency',
      walletTxsId: 'Transaction ID',
      walletTxsFilterCurrency: 'Currency',
      walletTxsFilterType: 'Type',
      walletTxsFilterEmpty: 'No options available.',
    },
    backoffice: {
      title: 'Backoffice',
      selectSection: 'Select1 a section from the left menu.',
      noSections: 'No available sections.',
      userLoadError: "Couldn't verify access permissions.",
      depositRequestsNav: 'Deposit requests',
      depositRequestsTitle: 'Deposit requests',
      depositRequestsPending: 'Pending actions',
      depositRequestsAll: 'All',
      depositRequestsEmpty: 'No deposit requests yet.',
      depositRequestsError: "Couldn't load deposit requests.",
      depositRequestTitle: 'Deposit request',
      depositRequestBack: 'Back to requests',
      depositRequestLoadError: "Couldn't load request.",
      depositRequestActionError: "Couldn't update request.",
      depositRequestInfo: 'Request details',
      depositRequestActions: 'Actions',
      depositRequestUserId: 'User ID',
      paymentDetailsLabel: 'Payment details',
      paymentDetailsPlaceholder: 'Enter payment details',
      paymentDetailsRequired: 'Enter payment details.',
      depositDetailsEmpty: 'Payment details have not been provided yet.',
      reject: 'Reject',
      rejectReasonRequired: 'Provide a rejection reason.',
      rejectReasonPlaceholder: 'Rejection reason',
      issueDetails: 'Provide details',
      confirm: 'Confirm',
    },
    home: {
