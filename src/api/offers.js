...
export function getOffer(offerCode) {
  return http.get(`/offers/${offerCode}`)
}
...
export function updateOffer(offerCode, payload) {
  return http.patch(`/offers/${offerCode}`, payload)
}
